...
sc <- LoadH5Seurat("./SS200000893TL_B3.TissueCut50.h5seurat",meta.data = T,misc=F)
...
scnew <- FindNeighbors(scnew, reduction = "pca", dims = 1:10)
for(i in seq(0.1,0.9,by=0.1)){
  scnew<-FindClusters(scnew,algorithm = 1,resolution = i) 
}
scnew <- RunUMAP(object = scnew, dims = 1:10)
scnew<-RunTSNE(scnew)
####marker plot
